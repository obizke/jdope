...
<html>
<head>
	<title>{{ config('app.name', 'jdope wear') }}</title>
<!--css-->
...
<meta name="keywords" content="Nairobi clothes online shop,maurice oboya ,jdope wear,best africans fashion websites, 
kenya best fashion trends,Nairobi men's collections,clothes stores in Nairobi cb" />
		...
		<div class="header">
			<div class="header-top">
				<div class="container">
					...
					<div class="top-right">
					<ul>
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="info@jdopewear.co.ke"> info@jdopewear.co.ke</a></li>
					</ul>
					</div>
